...
CREATE TABLE `tip_smestaja` (
  `tip_sme_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `tip_sme_tip` varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`tip_sme_id`)
...
INSERT INTO `tip_smestaja` VALUES (1,'Apartman'),(2,'Hotel');
